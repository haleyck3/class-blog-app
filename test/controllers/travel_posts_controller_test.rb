...
class TravelPostsControllerTest < ActionController::TestCase
  ...
  test "should create travel_post" do
    assert_difference('TravelPost.count') do
      post :create, travel_post: { author: @travel_post.author, title: @travel_post.title, travel_entry: @travel_post.travel_entry, type: @travel_post.type }
    end
  ...
  test "should update travel_post" do
    patch :update, id: @travel_post, travel_post: { author: @travel_post.author, title: @travel_post.title, travel_entry: @travel_post.travel_entry, type: @travel_post.type }
    assert_redirected_to travel_post_path(assigns(:travel_post))
  end
